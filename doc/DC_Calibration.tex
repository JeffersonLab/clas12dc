...
\usepackage[left=0.75in,top=0.75in,right=0.75in,bottom=0.8in]{geometry} % Document margins
...
\titlespacing\section{0pt}{-10pt plus 1pt minus 2pt}{0pt plus 1pt minus 2pt}

\setlength\parindent{0pt} %%% No indentation for paragraph
\usepackage[parfill]{parskip} %%% Use blank line as indication of new paragraph
...
\begin{aligned}
  p_0 & = v_0 \\
  p_1 & = \delta_{mn} = m - n  \\ %In the CCDB table and codes it was initially wrongly named as deltnam and has been kept that way.
  p_2 & = t_{max}   \\
  p_3 & = x_{\beta} \\ 
  p_4 & = \delta_{B} \\
  p_5 & = b_1  \\
