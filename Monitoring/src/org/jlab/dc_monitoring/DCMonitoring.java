...
public class DCMonitoring implements IDataEventListener {
	...
	private void createHistograms() {
		...
		for (int i = 0; i < 6; i++) {
			...
			for (int j = 0; j < 3; j++) {
				...
				cross_yvsx.get(new Coordinate(j, i)).setTitleX("x");
				cross_yvsx.get(new Coordinate(j, i)).setTitleY("y");
				cross_uyvsux.put(new Coordinate(j, i),
				        new H2F("Uy vs Ux sector" + (i + 1) + "region" + (j + 1), "sector"+(i+1) + "region" +(j+1), 100, -1, 1, 100, -1, 1));
				
				cross_uyvsux.get(new Coordinate(j, i)).setTitleX("U_x=t_x/t_z ");
				cross_uyvsux.get(new Coordinate(j, i)).setTitleY("U_y=t_y/t_z");
				if (j == 0) {
				...
				//times.get(new Coordinate(j, i)).setTitleX("time(ns) Sector" + (i + 1));
				times.get(new Coordinate(j, i)).setTitleX("time(ns)");
			...
			for (int j = 0; j < 7; j++) {
				if ((i == 0) || (i == 1)) {
					...
					timediff_s1.put(new Coordinate(i, j), new H1F("Delta t Sector 1 SL" + (i + 1) + "Board" + (j + 1),
							"SL" + (i + 1) + "Board" + (j + 1), 100, -1000, 1000));
					timediff_s2.put(new Coordinate(i, j), new H1F("Delta t Sector 2 SL" + (i + 1) + "Board" + (j + 1),
							"SL" + (i + 1) + "Board" + (j + 1), 100, -1000, 1000));
					timediff_s3.put(new Coordinate(i, j), new H1F("Delta t Sector 3 SL" + (i + 1) + "Board" + (j + 1),
							"SL" + (i + 1) + "Board" + (j + 1), 100, -1000, 1000));
				...
				timediff_s1.get(new Coordinate(i, j)).setTitleX("Delta time");
				timediff_s1.get(new Coordinate(i, j)).setTitleY("SL" + (i + 1));
				timediff_s2.get(new Coordinate(i, j)).setTitleX("Delta time ");
				timediff_s2.get(new Coordinate(i, j)).setTitleY("SL" + (i + 1));
				timediff_s3.get(new Coordinate(i, j)).setTitleX("Delta time");
				timediff_s3.get(new Coordinate(i, j)).setTitleY("SL" + (i + 1));
				timediff_s4.get(new Coordinate(i, j)).setTitleX("Delta time ");
				timediff_s4.get(new Coordinate(i, j)).setTitleY("SL" + (i + 1));
				timediff_s5.get(new Coordinate(i, j)).setTitleX("Delta time ");
				timediff_s5.get(new Coordinate(i, j)).setTitleY("SL" + (i + 1));
				timediff_s6.get(new Coordinate(i, j)).setTitleX("Delta time ");
			...
			Nhitspertrk.get(new Coordinate(i)).setTitleX("Number of hits/ track" );
			...
			Residual.put(new Coordinate(i), new H1F("Residual sector" + (i + 1), "sector" + (i + 1), 200, -0.5, 0.5));
			//Residual.get(new Coordinate(i)).setTitleX("Residual sector" + (i + 1));
			Residual.get(new Coordinate(i)).setTitleX("Residual(cm)");
			...
			Momentum.get(new Coordinate(i)).setTitleX("momentum (GeV/c)");
			...
			Theta.get(new Coordinate(i)).setTitleX("Theta(rad)");
			Phi.put(new Coordinate(i), new H1F("Phi sector" + (i + 1), "sector" + (i + 1), 100, -Math.PI, Math.PI));
			Phi.get(new Coordinate(i)).setTitleX("Phi(rad)");
			thetaVSmomenutm.put(new Coordinate(i), new H2F("Theta VS p sector" + (i + 1), "sector" + (i + 1), 100, 0, 8, 100, 0, Math.PI));
			thetaVSmomenutm.get(new Coordinate(i)).setTitleX("p (GeV/c)");
			thetaVSmomenutm.get(new Coordinate(i)).setTitleY("Theta(rad) ");
			thetaVSphi.put(new Coordinate(i),
			        new H2F("Theta VS phi sector" + (i + 1), "sector" + (i + 1), 100, -Math.PI, Math.PI, 100, 0, Math.PI));
			thetaVSphi.get(new Coordinate(i)).setTitleX("Phi(rad)");
			thetaVSphi.get(new Coordinate(i)).setTitleY("Theta(rad) ");
			for (int j = 0; j < 6; j++) {
				...
				if ((i == 0) || (i == 1)) {
					trkdocasvstime.put(new Coordinate(i, j),
							new H2F("TrackDoca vs time" + j + "SL"+(i+1), "sector"+(j+1) + "SL"+(i+1), 250, -100, 200, 50, 0, 1));
					residualVSDOCA.put(new Coordinate(i, j), new H2F("Residual vs DOCA sector "+(j+1)+" SL " + (i+1), "sector"+(j+1) + "SL"+(i+1), 200, 0, 1.0, 100, -1, 1));
				} else if ((i == 2) || (i == 3)) {
					trkdocasvstime.put(new Coordinate(i, j),
							new H2F("TrackDoca vs time" + j+ "SL"+(i+1), "sector"+(j+1) + "SL"+(i+1), 350, -100, 600, 100, 0, 2));
					residualVSDOCA.put(new Coordinate(i, j), new H2F("Residual vs DOCA sector "+(j+1)+" SL " + (i+1), "sector"+(j+1) + "SL"+(i+1), 200, 0, 1.6, 100, -1, 1));
				} else {
					trkdocasvstime.put(new Coordinate(i, j),
							new H2F("TrackDoca vs time" + j+ "SL"+(i+1), "sector"+(j+1) + "SL"+(i+1), 450, -100, 800, 100, 0, 2));
					residualVSDOCA.put(new Coordinate(i, j), new H2F("Residual vs DOCA sector "+(j+1)+" SL " + (i+1), "sector"+(j+1) + "SL"+(i+1), 200, 0, 2.5, 100, -1, 1));
				}
				//trkdocasvstime.get(new Coordinate(i, j)).setTitleX("time(ns) Sector" + (j + 1));
				trkdocasvstime.get(new Coordinate(i, j)).setTitleX("time(ns)");
				//trkdocasvstime.get(new Coordinate(i, j)).setTitleY("TrackDoca(cm) SL" + (i + 1));
				trkdocasvstime.get(new Coordinate(i, j)).setTitleY("TrkDOCA(cm)");
				//residualVSDOCA.get(new Coordinate(i, j)).setTitleX("TrkDOCA Sector" + (j + 1));
				residualVSDOCA.get(new Coordinate(i, j)).setTitleX("TrkDOCA(cm)");
				//residualVSDOCA.get(new Coordinate(i, j)).setTitleY("Residual SL" + (i + 1));
				residualVSDOCA.get(new Coordinate(i, j)).setTitleY("Residual(cm)");
			}
		}
	}
	...
	private void addCanvasToPane() {
		...
		tabbedPane.add("Crossing angles", can3);
		tabbedPane.add("Crossing position", can4);
